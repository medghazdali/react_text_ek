...
export default function YearDropDown({
  ...
  return (
    <Listbox value={selected} onChange={(year: string) => {
      setSelected(year);
      onYearSelected(year);
    }}>
      {({ open }) => (
        <>
          <Listbox.Label className="block text-sm font-medium text-gray-700">Année</Listbox.Label>
          <div className="mt-1 relative">
            <Listbox.Button
              ...
              <span className="block truncate">{selected ?? "Sélectionnez l'année"}</span>
